...
.parallax {
    /* The image used */
    background-image: url("https://res.cloudinary.com/bit-blog/images/w_868,h_576,c_scale/f_auto,q_auto/v1599236162/busss-669743-pGNuYOB8/busss-669743-pGNuYOB8-868x576.jpg?_i=AA");
    height: 100%;
...
<body data-spy="scroll" data-target=".navbar" data-offset="50" onload="myFunction()"> 
    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: blue;">
       ...
       <br><br>
        <div id="bus_route" class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-6">
                  <br>
                   <iframe src="https://res.cloudinary.com/bit-blog/images/w_868,h_576,c_scale/f_auto,q_auto/v1599236162/busss-669743-pGNuYOB8/busss-669743-pGNuYOB8-868x576.jpg?_i=AA" width="500" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                   <p>The Bus Route</p>
              </div>
          </div>       
        </div>
